...
Combat uses four abstract positions: **out of combat**, **long range**, **close range**, and **melee**.

Weapons, spells, and other effects use four abstract ranges: **Touch, 25 ft, 50 ft, and 100 ft**.

A **standard move** represents about 30 ft of movement. Changing range, engaging an enemy, joining or withdrawing from melee uses standard moves rather than exact squares.

Melee is a shifting area within close range. Creatures in the same melee are treated as able to reach one another without tracking exact adjacency or reach positioning.

Creature speed, Dash, opportunity attacks, forced movement, and area effects are adapted to work with the zone system. An extended-range variant doubles the normal ranges for battles in open terrain.
...
© Sly Gryphon, version 2026.09.06. This work is licensed under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).